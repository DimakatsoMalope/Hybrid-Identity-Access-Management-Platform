# Hybrid-Identity-Access-Management-Platform


This project demonstrates the design, implementation, testing, and operational validation of a production-style hybrid identity environment using Microsoft Active Directory and Microsoft Entra ID. The environment includes hybrid identity synchronization, modern authentication, enterprise single sign-on, Conditional Access, Microsoft Graph automation, and operational runbooks for common identity incidents.
...
15. **Implement role-based access control (RBAC) using synchronized Active Directory security groups.** — `SSO-Employees` (48 members), `SSO-Contractors` (18 members), `SSO-Admins` (8 members, IT department), `SSO-AllUsers` (66 members). Groups synced to Entra after correcting OU scope to include the Groups OU.
...
*Hybrid Identity Lab — This project demonstrates the end-to-end implementation of a hybrid enterprise identity platform, including Active Directory, Microsoft Entra ID, hybrid synchronization, modern authentication, Conditional Access, Microsoft Graph automation, and operational identity management. It was designed to replicate real-world IAM engineering responsibilities while producing reusable operational documentation and incident response procedures.*
